...
### Track A: Default (non-SSR projects)
...
Full details: `references/stacks-yy-default.md`.
...
|--------|------|-------------|
| Default (non-SSR) | `references/stacks-yy-default.md` | Opinionated default for non-SSR projects (Bun+Hono+Vite+Expo) |
